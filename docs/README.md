...
The deployment url is: [https://HugoLebredo.github.io/dede/](https://HugoLebredo.github.io/dede/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://HugoLebredo.github.io/dede/](https://HugoLebredo.github.io/dede/) we need to execute `npm run deploy`.
